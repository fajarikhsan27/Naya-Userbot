...
STRINGS = {
    1: """ **Terima Kasih Telah Deploy Fajar-Userbot!**

Beberapa Bantuan Untuk Kamu Pelajari.""",
    2: """🎉** Tentang Fajar-Userbot**

 Fajar-Userbot adalah repo userbot yanh dibuat untuk kekasih saya, userbot ini memiliki beberapa fitur kamu bisa melihat nya dihalaman 4.

❣ Dibuat oleh **@thelightch**""",
    3: """
